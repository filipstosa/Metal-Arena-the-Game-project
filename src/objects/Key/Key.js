...
export class Key extends GameObject {
    ...
    ready() {
            ...
            if ((roundedHeroX >= (this.position.x - 13.0625*8) && roundedHeroX <= (this.position.x + 13.0625*8)) && (roundedHeroY >= (this.position.y - 13.0625*8) && roundedHeroY <= (this.position.y + 13.0625*8))) {
